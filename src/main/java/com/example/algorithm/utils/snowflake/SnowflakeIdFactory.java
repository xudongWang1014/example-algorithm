...
public class SnowflakeIdFactory implements Serializable {
    ...
    public static volatile Map<Long, Long> longMap = new ConcurrentHashMap<>();
    public static volatile Map<String, String> stringMap = new ConcurrentHashMap<>();
    ...
    public synchronized long nextLongId() {
        ...
        if(longMap.containsKey(tempId)){
            throw new RuntimeException(tempId + "  long id 重复");
        }

        longMap.put(tempId, tempId);
